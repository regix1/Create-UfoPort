...
public class RegistrateRecipeProvider extends FabricRecipeProvider implements RegistrateProvider {
    private final AbstractRegistrate<?> owner;

    public RegistrateRecipeProvider(AbstractRegistrate<?> owner, FabricDataOutput output, CompletableFuture<Provider> registryLookup) {
    ...
    public RecipeOutput getCallback() {
		return callback;
	}
...
//    }
    ...
    public <T extends AbstractCookingRecipe> void cooking(DataIngredient source, AbstractCookingRecipe.Factory<T> factory, RecipeCategory category, Supplier<? extends ItemLike> result, float experience, int cookingTime, RecipeSerializer<T> serializer) {
        cooking(source, factory, category, result, experience, cookingTime, COOKING_TYPE_NAMES.get(serializer), serializer);
    }

    public <T extends AbstractCookingRecipe>void cooking(DataIngredient source, AbstractCookingRecipe.Factory<T> factory, RecipeCategory category, Supplier<? extends ItemLike> result, float experience, int cookingTime, String typeName, RecipeSerializer<T> serializer) {
    	SimpleCookingRecipeBuilder.generic(source, category, result.get(), experience, cookingTime, serializer, factory)
            ...
            .save(callback, safeId(result.get()) + "_from_" + safeName(source) + "_" + typeName);
    }
    ...
    public <T extends ItemLike> void smelting(DataIngredient source, RecipeCategory category, Supplier<? extends T> result, float experience, int cookingTime) {
        cooking(source, SmeltingRecipe::new, category, result, experience, cookingTime, RecipeSerializer.SMELTING_RECIPE);
    }
    ...
    public <T extends ItemLike> void blasting(DataIngredient source, RecipeCategory category, Supplier<? extends T> result, float experience, int cookingTime) {
        cooking(source, BlastingRecipe::new, category, result, experience, cookingTime, RecipeSerializer.BLASTING_RECIPE);
    }
    ...
    public <T extends ItemLike> void smoking(DataIngredient source, RecipeCategory category, Supplier<? extends T> result, float experience, int cookingTime) {
        cooking(source, SmokingRecipe::new, category, result, experience, cookingTime, RecipeSerializer.SMOKING_RECIPE);
    }
    ...
    public <T extends ItemLike> void campfire(DataIngredient source, RecipeCategory category, Supplier<? extends T> result, float experience, int cookingTime) {
        cooking(source, CampfireCookingRecipe::new, category, result, experience, cookingTime, RecipeSerializer.CAMPFIRE_COOKING_RECIPE);
    }
    ...
    public <T extends ItemLike> void stonecutting(DataIngredient source, RecipeCategory category, Supplier<? extends T> result, int resultAmount) {
        SingleItemRecipeBuilder.stonecutting(source, category, result.get(), resultAmount)
            .unlockedBy("has_" + safeName(source), source.getCritereon(this))
            .save(callback, safeId(result.get()) + "_from_" + safeName(source) + "_stonecutting");
    }
    ...
    public <T extends ItemLike> void square(DataIngredient source, RecipeCategory category, Supplier<? extends T> output, boolean small) {
        ...
        builder.unlockedBy("has_" + safeName(source), source.getCritereon(this))
            .save(callback, safeId(output.get()));
    }
    ...
    public <T extends ItemLike> void storage(DataIngredient source, RecipeCategory category, NonNullSupplier<? extends T> output) {
        ...
        singleItemUnfinished(source, category, output, 1, 9)
            .save(callback, safeId(source) + "_from_" + safeName(BuiltInRegistries.ITEM.getKey(output.get().asItem())));
    }
    ...
    public <T extends ItemLike> void storage(DataIngredient sourceIngredient, RecipeCategory category, NonNullSupplier<? extends T> source, DataIngredient outputIngredient, NonNullSupplier<? extends T> output) {
        ...
        singleItemUnfinished(outputIngredient, category, source, 1, 9)
            .save(callback, safeId(sourceIngredient) + "_from_" + safeName(BuiltInRegistries.ITEM.getKey(output.get().asItem())));
    }
...
//    @CheckReturnValue
    ...
    public <T extends ItemLike> void singleItem(DataIngredient source, RecipeCategory category, Supplier<? extends T> result, int required, int amount) {
        singleItemUnfinished(source, category, result, required, amount).save(callback, safeId(result.get()));
    }
    ...
    public <T extends ItemLike> void planks(DataIngredient source, RecipeCategory category, Supplier<? extends T> result) {
        singleItemUnfinished(source, category, result, 1, 4)
            .group("planks")
            .save(callback, safeId(result.get()));
    }
    ...
    public CompletableFuture<?> buildAdvancement(CachedOutput p_253674_, HolderLookup.Provider registryLookup, AdvancementHolder holder) { return super.buildAdvancement(p_253674_, registryLookup, holder); }

    /** Generated override to expose protected method: {@link RecipeProvider#oreSmelting} */
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static void oreSmelting(RecipeOutput p_250654_, List<ItemLike> p_250172_, RecipeCategory p_250588_, ItemLike p_251868_, float p_250789_, int p_252144_, String p_251687_) { RecipeProvider.oreSmelting(p_250654_, p_250172_, p_250588_, p_251868_, p_250789_, p_252144_, p_251687_); }

    /** Generated override to expose protected method: {@link RecipeProvider#oreBlasting} */
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static void oreBlasting(RecipeOutput p_248775_, List<ItemLike> p_251504_, RecipeCategory p_248846_, ItemLike p_249735_, float p_248783_, int p_250303_, String p_251984_) { RecipeProvider.oreBlasting(p_248775_, p_251504_, p_248846_, p_249735_, p_248783_, p_250303_, p_251984_); }

    /** Generated override to expose protected method: {@link RecipeProvider#oreCooking} */
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static <T extends AbstractCookingRecipe> void oreCooking(RecipeOutput p_250791_, RecipeSerializer<T> p_251817_, AbstractCookingRecipe.Factory<T> p_2518171_, List<ItemLike> p_249619_, RecipeCategory p_251154_, ItemLike p_250066_, float p_251871_, int p_251316_, String p_251450_, String p_249236_) { RecipeProvider.oreCooking(p_250791_, p_251817_, p_2518171_, p_249619_, p_251154_, p_250066_, p_251871_, p_251316_, p_251450_, p_249236_); }

    /** Generated override to expose protected method: {@link RecipeProvider#netheriteSmithing} */
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static void netheriteSmithing(RecipeOutput p_251614_, Item p_250046_, RecipeCategory p_248986_, Item p_250389_) { RecipeProvider.netheriteSmithing(p_251614_, p_250046_, p_248986_, p_250389_); }

    /** Generated override to expose protected method: {@link RecipeProvider#trimSmithing} */
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static void trimSmithing(RecipeOutput p_285086_, Item p_285461_, ResourceLocation p_285044_) { RecipeProvider.trimSmithing(p_285086_, p_285461_, p_285044_); }

    /** Generated override to expose protected method: {@link RecipeProvider#twoByTwoPacker} */
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static void twoByTwoPacker(RecipeOutput p_248860_, RecipeCategory p_250881_, ItemLike p_252184_, ItemLike p_249710_) { RecipeProvider.twoByTwoPacker(p_248860_, p_250881_, p_252184_, p_249710_); }

    /** Generated override to expose protected method: {@link RecipeProvider#threeByThreePacker} */
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static void threeByThreePacker(RecipeOutput p_259036_, RecipeCategory p_259247_, ItemLike p_259376_, ItemLike p_259717_, String p_260308_) { RecipeProvider.threeByThreePacker(p_259036_, p_259247_, p_259376_, p_259717_, p_260308_); }

    /** Generated override to expose protected method: {@link RecipeProvider#threeByThreePacker} */
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static void threeByThreePacker(RecipeOutput p_260012_, RecipeCategory p_259186_, ItemLike p_259360_, ItemLike p_259263_) { RecipeProvider.threeByThreePacker(p_260012_, p_259186_, p_259360_, p_259263_); }

    /** Generated override to expose protected method: {@link RecipeProvider#planksFromLog} */
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static void planksFromLog(RecipeOutput p_259712_, ItemLike p_259052_, TagKey<Item> p_259045_, int p_259471_) { RecipeProvider.planksFromLog(p_259712_, p_259052_, p_259045_, p_259471_); }

    /** Generated override to expose protected method: {@link RecipeProvider#planksFromLogs} */
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static void planksFromLogs(RecipeOutput p_259910_, ItemLike p_259193_, TagKey<Item> p_259818_, int p_259807_) { RecipeProvider.planksFromLogs(p_259910_, p_259193_, p_259818_, p_259807_); }

    /** Generated override to expose protected method: {@link RecipeProvider#woodFromLogs} */
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static void woodFromLogs(RecipeOutput p_126003_, ItemLike p_126004_, ItemLike p_126005_) { RecipeProvider.woodFromLogs(p_126003_, p_126004_, p_126005_); }

    /** Generated override to expose protected method: {@link RecipeProvider#woodenBoat} */
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static void woodenBoat(RecipeOutput p_126022_, ItemLike p_126023_, ItemLike p_126024_) { RecipeProvider.woodenBoat(p_126022_, p_126023_, p_126024_); }

    /** Generated override to expose protected method: {@link RecipeProvider#chestBoat} */
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static void chestBoat(RecipeOutput p_236372_, ItemLike p_236373_, ItemLike p_236374_) { RecipeProvider.chestBoat(p_236372_, p_236373_, p_236374_); }
    ...
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static void pressurePlate(RecipeOutput p_176691_, ItemLike p_176692_, ItemLike p_176693_) { RecipeProvider.pressurePlate(p_176691_, p_176692_, p_176693_); }
    ...
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static void slab(RecipeOutput p_248880_, RecipeCategory p_251848_, ItemLike p_249368_, ItemLike p_252133_) { RecipeProvider.slab(p_248880_, p_251848_, p_249368_, p_252133_); }
    ...
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static void hangingSign(RecipeOutput p_250663_, ItemLike p_252355_, ItemLike p_250437_) { RecipeProvider.hangingSign(p_250663_, p_252355_, p_250437_); }

    /** Generated override to expose protected method: {@link RecipeProvider#colorBlockWithDye} */
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static void colorBlockWithDye(RecipeOutput p_289666_, List<Item> p_289675_, List<Item> p_289672_, String p_289641_) { RecipeProvider.colorBlockWithDye(p_289666_, p_289675_, p_289672_, p_289641_); }

    /** Generated override to expose protected method: {@link RecipeProvider#carpet} */
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static void carpet(RecipeOutput p_176717_, ItemLike p_176718_, ItemLike p_176719_) { RecipeProvider.carpet(p_176717_, p_176718_, p_176719_); }

    /** Generated override to expose protected method: {@link RecipeProvider#bedFromPlanksAndWool} */
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static void bedFromPlanksAndWool(RecipeOutput p_126074_, ItemLike p_126075_, ItemLike p_126076_) { RecipeProvider.bedFromPlanksAndWool(p_126074_, p_126075_, p_126076_); }

    /** Generated override to expose protected method: {@link RecipeProvider#banner} */
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static void banner(RecipeOutput p_126082_, ItemLike p_126083_, ItemLike p_126084_) { RecipeProvider.banner(p_126082_, p_126083_, p_126084_); }

    /** Generated override to expose protected method: {@link RecipeProvider#stainedGlassFromGlassAndDye} */
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static void stainedGlassFromGlassAndDye(RecipeOutput p_126086_, ItemLike p_126087_, ItemLike p_126088_) { RecipeProvider.stainedGlassFromGlassAndDye(p_126086_, p_126087_, p_126088_); }

    /** Generated override to expose protected method: {@link RecipeProvider#stainedGlassPaneFromStainedGlass} */
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static void stainedGlassPaneFromStainedGlass(RecipeOutput p_126090_, ItemLike p_126091_, ItemLike p_126092_) { RecipeProvider.stainedGlassPaneFromStainedGlass(p_126090_, p_126091_, p_126092_); }

    /** Generated override to expose protected method: {@link RecipeProvider#stainedGlassPaneFromGlassPaneAndDye} */
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static void stainedGlassPaneFromGlassPaneAndDye(RecipeOutput p_126094_, ItemLike p_126095_, ItemLike p_126096_) { RecipeProvider.stainedGlassPaneFromGlassPaneAndDye(p_126094_, p_126095_, p_126096_); }

    /** Generated override to expose protected method: {@link RecipeProvider#coloredTerracottaFromTerracottaAndDye} */
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static void coloredTerracottaFromTerracottaAndDye(RecipeOutput p_126098_, ItemLike p_126099_, ItemLike p_126100_) { RecipeProvider.coloredTerracottaFromTerracottaAndDye(p_126098_, p_126099_, p_126100_); }

    /** Generated override to expose protected method: {@link RecipeProvider#concretePowder} */
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static void concretePowder(RecipeOutput p_126102_, ItemLike p_126103_, ItemLike p_126104_) { RecipeProvider.concretePowder(p_126102_, p_126103_, p_126104_); }

    /** Generated override to expose protected method: {@link RecipeProvider#candle} */
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static void candle(RecipeOutput p_176543_, ItemLike p_176544_, ItemLike p_176545_) { RecipeProvider.candle(p_176543_, p_176544_, p_176545_); }

    /** Generated override to expose protected method: {@link RecipeProvider#wall} */
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static void wall(RecipeOutput p_251034_, RecipeCategory p_251148_, ItemLike p_250499_, ItemLike p_249970_) { RecipeProvider.wall(p_251034_, p_251148_, p_250499_, p_249970_); }
    ...
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static void polished(RecipeOutput p_251348_, RecipeCategory p_248719_, ItemLike p_250032_, ItemLike p_250021_) { RecipeProvider.polished(p_251348_, p_248719_, p_250032_, p_250021_); }
    ...
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static void cut(RecipeOutput p_248712_, RecipeCategory p_252306_, ItemLike p_249686_, ItemLike p_251100_) { RecipeProvider.cut(p_248712_, p_252306_, p_249686_, p_251100_); }
    ...
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static void chiseled(RecipeOutput p_250120_, RecipeCategory p_251604_, ItemLike p_251049_, ItemLike p_252267_) { RecipeProvider.chiseled(p_250120_, p_251604_, p_251049_, p_252267_); }

    /** Generated override to expose protected method: {@link RecipeProvider#mosaicBuilder} */
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static void mosaicBuilder(RecipeOutput p_249200_, RecipeCategory p_248788_, ItemLike p_251925_, ItemLike p_252242_) { RecipeProvider.mosaicBuilder(p_249200_, p_248788_, p_251925_, p_252242_); }
    ...
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static void stonecutterResultFromBase(RecipeOutput p_251589_, RecipeCategory p_248911_, ItemLike p_251265_, ItemLike p_250033_) { RecipeProvider.stonecutterResultFromBase(p_251589_, p_248911_, p_251265_, p_250033_); }

    /** Generated override to expose protected method: {@link RecipeProvider#stonecutterResultFromBase} */
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static void stonecutterResultFromBase(RecipeOutput p_249145_, RecipeCategory p_250609_, ItemLike p_251254_, ItemLike p_249666_, int p_251462_) { RecipeProvider.stonecutterResultFromBase(p_249145_, p_250609_, p_251254_, p_249666_, p_251462_); }

    /** Generated override to expose protected method: {@link RecipeProvider#smeltingResultFromBase} */
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static void smeltingResultFromBase(RecipeOutput p_176740_, ItemLike p_176741_, ItemLike p_176742_) { RecipeProvider.smeltingResultFromBase(p_176740_, p_176741_, p_176742_); }

    /** Generated override to expose protected method: {@link RecipeProvider#nineBlockStorageRecipes} */
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static void nineBlockStorageRecipes(RecipeOutput p_249580_, RecipeCategory p_251203_, ItemLike p_251689_, RecipeCategory p_251376_, ItemLike p_248771_) { RecipeProvider.nineBlockStorageRecipes(p_249580_, p_251203_, p_251689_, p_251376_, p_248771_); }

    /** Generated override to expose protected method: {@link RecipeProvider#nineBlockStorageRecipesWithCustomPacking} */
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static void nineBlockStorageRecipesWithCustomPacking(RecipeOutput p_250488_, RecipeCategory p_250885_, ItemLike p_251651_, RecipeCategory p_250874_, ItemLike p_248576_, String p_250171_, String p_249386_) { RecipeProvider.nineBlockStorageRecipesWithCustomPacking(p_250488_, p_250885_, p_251651_, p_250874_, p_248576_, p_250171_, p_249386_); }

    /** Generated override to expose protected method: {@link RecipeProvider#nineBlockStorageRecipesRecipesWithCustomUnpacking} */
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static void nineBlockStorageRecipesRecipesWithCustomUnpacking(RecipeOutput p_250320_, RecipeCategory p_248979_, ItemLike p_249101_, RecipeCategory p_252036_, ItemLike p_250886_, String p_248768_, String p_250847_) { RecipeProvider.nineBlockStorageRecipesRecipesWithCustomUnpacking(p_250320_, p_248979_, p_249101_, p_252036_, p_250886_, p_248768_, p_250847_); }

    /** Generated override to expose protected method: {@link RecipeProvider#copySmithingTemplate} */
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static void copySmithingTemplate(RecipeOutput p_267061_, ItemLike p_266974_, TagKey<Item> p_267283_) { RecipeProvider.copySmithingTemplate(p_267061_, p_266974_, p_267283_); }

    /** Generated override to expose protected method: {@link RecipeProvider#copySmithingTemplate} */
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static void copySmithingTemplate(RecipeOutput p_266734_, ItemLike p_267133_, ItemLike p_267023_) { RecipeProvider.copySmithingTemplate(p_266734_, p_267133_, p_267023_); }

    /** Generated override to expose protected method: {@link RecipeProvider#cookRecipes} */
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static <T extends AbstractCookingRecipe> void cookRecipes(RecipeOutput p_126007_, String p_126008_, RecipeSerializer<T> p_250529_, AbstractCookingRecipe.Factory<T> p_2505291_, int p_126010_) { RecipeProvider.cookRecipes(p_126007_, p_126008_, p_250529_, p_2505291_, p_126010_); }

    /** Generated override to expose protected method: {@link RecipeProvider#simpleCookingRecipe} */
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static <T extends AbstractCookingRecipe> void simpleCookingRecipe(RecipeOutput p_249398_, String p_249709_, RecipeSerializer<T> p_251876_, AbstractCookingRecipe.Factory<T> p_2505291_,  int p_249258_, ItemLike p_250669_, ItemLike p_250224_, float p_252138_) { RecipeProvider.simpleCookingRecipe(p_249398_, p_249709_, p_251876_, p_2505291_, p_249258_, p_250669_, p_250224_, p_252138_); }

    /** Generated override to expose protected method: {@link RecipeProvider#waxRecipes} */
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static void waxRecipes(RecipeOutput p_176611_, FeatureFlagSet set) { RecipeProvider.waxRecipes(p_176611_, set); }

    /** Generated override to expose protected method: {@link RecipeProvider#generateRecipes} */
    @Generated(value = "com.tterrag.registrate.test.meta.UpdateRecipeProvider", date = "Fri, 9 Jun 2023 04:03:23 GMT")
    public static void generateRecipes(RecipeOutput p_176581_, BlockFamily p_176582_, FeatureFlagSet set) { RecipeProvider.generateRecipes(p_176581_, p_176582_, set); }
