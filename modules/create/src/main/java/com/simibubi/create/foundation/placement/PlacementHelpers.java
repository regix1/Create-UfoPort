...
//		RenderSystem.disableTexture();
		...
		bufferbuilder.addVertex(mat, 0, -(10 + length), 0)
			.setColor(r, g, b, a)
			;

		bufferbuilder.addVertex(mat, -9, -3, 0)
			.setColor(r, g, b, 0f)
			;
		bufferbuilder.addVertex(mat, -6, -6, 0)
			.setColor(r, g, b, 0f)
			;
		bufferbuilder.addVertex(mat, -3, -8, 0)
			.setColor(r, g, b, 0f)
			;
		bufferbuilder.addVertex(mat, 0, -8.5f, 0)
			.setColor(r, g, b, 0f)
			;
		bufferbuilder.addVertex(mat, 3, -8, 0)
			.setColor(r, g, b, 0f)
