...
import io.github.fabricators_of_create.porting_lib_ufo.item.EntitySwingListenerItem;
...
public class PotatoCannonItem extends ProjectileWeaponItem implements CustomArmPoseItem, EntitySwingListenerItem, ReequipAnimationItem, CustomEnchantingBehaviorItem {
	...
	public boolean canApplyAtEnchantingTable(ItemStack stack, Enchantment enchantment) {
		if (enchantment == Create.getHolderForEnchantment(Enchantments.POWER).value())
			return true;
		if (enchantment == Create.getHolderForEnchantment(Enchantments.PUNCH).value())
			return true;
		if (enchantment == Create.getHolderForEnchantment(Enchantments.FLAME).value())
			return true;
		if (enchantment == Create.getHolderForEnchantment(Enchantments.LOOTING).value())
			return true;
		if (enchantment == Create.getHolderForEnchantment(AllEnchantments.POTATO_RECOVERY).value())
			return true;
	...
	public void appendHoverText(ItemStack stack, TooltipContext context,  List<Component> tooltip, TooltipFlag flag) {
		int power = EnchantmentHelper.getItemEnchantmentLevel(Create.getHolderForEnchantment(Enchantments.POWER), stack);
		int punch = EnchantmentHelper.getItemEnchantmentLevel(Create.getHolderForEnchantment(Enchantments.PUNCH), stack);
