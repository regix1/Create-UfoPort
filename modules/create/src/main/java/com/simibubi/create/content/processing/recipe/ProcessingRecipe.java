...
//	public static StreamCodec<RegistryFriendlyByteBuf, ProcessingRecipe<?>> STREAM_CODEC = StreamCodec.composite(
//		ResourceLocation.STREAM_CODEC, ProcessingRecipe::id,
//		Ingredient.CONTENTS_STREAM_CODEC.apply(ByteBufCodecs.collection(NonNullList::createWithCapacity)), ProcessingRecipe::ingredients,
//		ProcessingOutput.STREAM_CODEC.apply(ByteBufCodecs.collection(NonNullList::createWithCapacity)), ProcessingRecipe::results,
//		FluidIngredient.STREAM_CODEC.apply(ByteBufCodecs.collection(NonNullList::createWithCapacity)), ProcessingRecipe::fluidIngredients,
//		FluidStack.STREAM_CODEC.apply(ByteBufCodecs.collection(NonNullList::createWithCapacity)), ProcessingRecipe::fluidResults,
//		
//	);
	...
	@Override
	public ItemStack assemble(T inv, Provider var2) {
		return getResultItem(var2);
	}
	...
	@Override
	public ItemStack getResultItem(Provider var1) {
	...
	public static ProcessingCodecBuilder defaultCodec() {
		return ProcessingCodecBuilder.getDefaultBuilder();
	}

	// Additional Data added by subtypes

	public void readAdditional(List<Object> json) {}

	public void readAdditional(FriendlyByteBuf buffer) {}

	public void writeAdditional(List<Object> json) {}
