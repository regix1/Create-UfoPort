...
public class StandardRecipeGen extends CreateRecipeProvider {
	...
	TOOLBOX = create(AllBlocks.TOOLBOXES.get(DyeColor.BROWN)).unlockedByTag(I::goldSheet)
		...
		TOOLBOX_DYEING = createSpecial(AllRecipeTypes.TOOLBOX_DYEING.getSimpleFactory(), "crafting", "toolbox_dyeing"),
	...
	GeneratedRecipe createSpecial(Function<CraftingBookCategory, Recipe<?>> recipeFactory, String recipeType,
		String path) {
		ResourceLocation location = Create.asResource(recipeType + "/" + currentFolder + "/" + path);
		return register(consumer -> {
			SpecialRecipeBuilder b = SpecialRecipeBuilder.special(recipeFactory);
...
//			
//			private final AbstractCookingRecipe.Factory<? extends AbstractCookingRecipe> FURNACE_NEW = SmeltingRecipe::new,
//					SMOKER_NEW = SmokingRecipe::new, BLAST_NEW = BlastingRecipe::new,
//					CAMPFIRE_NEW = CampfireCookingRecipe::new;
			...
			GeneratedRecipe inFurnace(UnaryOperator<SimpleCookingRecipeBuilder> builder) {
				return create(RecipeSerializer.SMELTING_RECIPE, SmeltingRecipe::new, builder, 1);
			}
			...
			GeneratedRecipe inSmoker(UnaryOperator<SimpleCookingRecipeBuilder> builder) {
				create(RecipeSerializer.SMELTING_RECIPE, SmeltingRecipe::new, builder, 1);
				create(RecipeSerializer.CAMPFIRE_COOKING_RECIPE, CampfireCookingRecipe::new, builder, 3);
				return create(RecipeSerializer.SMOKING_RECIPE, SmokingRecipe::new, builder, .5f);
			}
			...
			GeneratedRecipe inBlastFurnace(UnaryOperator<SimpleCookingRecipeBuilder> builder) {
				create(RecipeSerializer.SMELTING_RECIPE, SmeltingRecipe::new, builder, 1);
				return create(RecipeSerializer.BLASTING_RECIPE, BlastingRecipe::new, builder, .5f);
			}
...
//						.getPath()));
	...
	public StandardRecipeGen(FabricDataOutput p_i48262_1_, CompletableFuture<HolderLookup.Provider> registriesFuture) {
