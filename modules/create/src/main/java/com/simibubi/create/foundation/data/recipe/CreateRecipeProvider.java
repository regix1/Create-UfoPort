...
public abstract class CreateRecipeProvider extends FabricRecipeProvider {
	...
	public CreateRecipeProvider(FabricDataOutput output, CompletableFuture<HolderLookup.Provider> registriesFuture) {
	...
	protected GeneratedRecipe register(GeneratedRecipe recipe) {
		if(recipe == null)
			throw new IllegalArgumentException("Null GeneratedRecipe: "+recipe);
		all.add(recipe);
		return recipe;
	}
	...
	public interface GeneratedRecipe {
		void register(RecipeOutput exporter);
	}
