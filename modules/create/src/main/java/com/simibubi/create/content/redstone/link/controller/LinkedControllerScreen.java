...
import io.github.fabricators_of_create.porting_lib_ufo.mixin.accessors.common.accessor.SlotAccessor;
import io.github.fabricators_of_create.porting_lib_ufo.util.ItemStackUtil;
import io.github.fabricators_of_create.porting_lib_ufo.util.PlayerEntityHelper;
...
//			LogUtils.getLogger().info("containerTick close");
//			LogUtils.getLogger().info(menu.player.getMainHandItem()+"; "+menu.contentHolder);
//			LogUtils.getLogger().info(menu.player.getMainHandItem().getComponents()+"");
//			LogUtils.getLogger().info(menu.contentHolder.getComponents()+"");
//			ItemStack is = menu.player.getMainHandItem();
