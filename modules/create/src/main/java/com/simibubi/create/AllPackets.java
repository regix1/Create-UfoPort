...
import com.simibubi.create.compat.cobblemon.CobblemonSeatPCBoxDataPacket;
import com.simibubi.create.compat.cobblemon.CobblemonSeatPCBoxRequestPacket;
...
import com.simibubi.create.content.equipment.symmetryWand.UpdateSymmetryWandPacket;
...
public enum AllPackets {
	...
	UPDATE_SYMMETRY_WAND(UpdateSymmetryWandPacket.class, UpdateSymmetryWandPacket::new, PLAY_TO_CLIENT),
	...
	COBBLEMON_SEAT_PC_BOX_REQUEST(CobblemonSeatPCBoxRequestPacket.class, CobblemonSeatPCBoxRequestPacket::new, PLAY_TO_SERVER),
	...
	COBBLEMON_SEAT_PC_BOX_DATA(CobblemonSeatPCBoxDataPacket.class, CobblemonSeatPCBoxDataPacket::new, PLAY_TO_CLIENT),
	...
	<T extends SimplePacketBase> AllPackets(Class<T> type, Function<RegistryFriendlyByteBuf, T> factory,
	...
	private static class PacketType<T extends SimplePacketBase> {
		...
		private Function<RegistryFriendlyByteBuf, T> decoder;
		private Class<T> type;
		private NetworkDirection direction;

		private PacketType(Class<T> type, Function<RegistryFriendlyByteBuf, T> factory, NetworkDirection direction) {
			decoder = factory;
			this.type = type;
