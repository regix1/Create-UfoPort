...
public interface SignalGetterMixin extends BlockGetter {
	...
	private boolean port_lib$modifyRedstoneSignal(BlockState state, BlockGetter level, BlockPos pos,
			Operation<Boolean> original, BlockPos pos2, Direction facing) {
