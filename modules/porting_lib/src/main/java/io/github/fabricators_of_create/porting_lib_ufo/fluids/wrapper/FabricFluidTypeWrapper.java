package io.github.fabricators_of_create.porting_lib_ufo.fluids.wrapper;
...
/**
 * If you're just using fluid types then make sure you register this for your
 * fluid using
 * {@link net.fabricmc.fabric.api.transfer.v1.fluid.FluidVariantAttributes#register(Fluid, FluidVariantAttributeHandler)}
 */
public class FabricFluidTypeWrapper implements FluidVariantAttributeHandler {
	...
	public Optional<SoundEvent> getFillSound(FluidVariant variant) {
		return Optional
				.ofNullable(type.getSound(new FluidStack(variant, FluidConstants.BUCKET), SoundActions.BUCKET_FILL));
	}

	@Override
	public Optional<SoundEvent> getEmptySound(FluidVariant variant) {
		return Optional
				.ofNullable(type.getSound(new FluidStack(variant, FluidConstants.BUCKET), SoundActions.BUCKET_EMPTY));
	}
