package io.github.fabricators_of_create.porting_lib_ufo.event.client;
...
public class MouseInputEvents {
	/**
	 * Fired before a mouse button press is handled. Can be used to cancel
	 * interactions.
	 */
	public static final Event<BeforeButton> BEFORE_BUTTON = EventFactory.createArrayBacked(BeforeButton.class,
			callbacks -> (button, modifiers, action) -> {
	 ...
	 */
	public static final Event<AfterButton> AFTER_BUTTON = EventFactory.createArrayBacked(AfterButton.class,
			callbacks -> (button, modifiers, action) -> {
	 ...
	 */
	public static final Event<BeforeScroll> BEFORE_SCROLL = EventFactory.createArrayBacked(BeforeScroll.class,
			callbacks -> (deltaX, deltaY) -> {
	 ...
	 */
	public static final Event<AfterScroll> AFTER_SCROLL = EventFactory.createArrayBacked(AfterScroll.class,
			callbacks -> (deltaX, deltaY) -> {
	...
	public interface BeforeButton {
		 ...
		 * @param modifiers bit flags for button modifiers, see {@link GLFW} GLFW_MOD
		 *                  values
