...
public class BeehiveBlockMixin {
	...
	private boolean supportsToolAction(boolean original, ItemStack origStack, BlockState state, Level world, BlockPos pos, Player player, InteractionHand hand, BlockHitResult hit) {
