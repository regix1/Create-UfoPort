...
import io.github.fabricators_of_create.porting_lib_ufo.models.generators.block.MultiPartBlockStateBuilder.PartBuilder;
import io.github.fabricators_of_create.porting_lib_ufo.models.generators.block.VariantBlockStateBuilder.PartialBlockstate;
...
public final class ConfiguredModel {
	...
	public static Builder<VariantBlockStateBuilder> builder(VariantBlockStateBuilder outer, PartialBlockstate state) {
		return new Builder<>(models -> outer.setModels(state, models), ImmutableList.of());
	}

	public static Builder<PartBuilder> builder(MultiPartBlockStateBuilder outer) {
