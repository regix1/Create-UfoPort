package io.github.fabricators_of_create.porting_lib_ufo.tool;
...
import io.github.fabricators_of_create.porting_lib_ufo.tool.extensions.BlockExtensions;
...
public class ToolActions {
	...
	/**
	 * Passed onto {@link BlockExtensions#getToolModifiedState} when an axe wants to
	 * strip a log
	 */
	...
	/**
	 * Passed onto {@link BlockExtensions#getToolModifiedState} when an axe wants to
	 * scrape oxidization off copper
	 */
	public static final ToolAction AXE_SCRAPE = ToolAction.get("axe_scrape");

	/**
	 * Passed onto {@link BlockExtensions#getToolModifiedState} when an axe wants to
	 * remove wax out of copper
	 */
	public static final ToolAction AXE_WAX_OFF = ToolAction.get("axe_wax_off");

	/**
	 * Passed onto {@link BlockExtensions#getToolModifiedState} when a shovel wants
	 * to turn dirt into path
	 */
	...
	/**
	 * This action is exposed by shears and corresponds to a harvest action that is
	 * triggered with a right click on a block that supports such behaviour.
	 * Example: Right click with shears on a beehive with honey level 5 to harvest
	 * it
	 */
	public static final ToolAction SHEARS_HARVEST = ToolAction.get("shears_harvest");

	/**
	 * This action is exposed by shears and corresponds to a carve action that is
	 * triggered with a right click on a block that supports such behaviour.
	...
	/**
	 * This action is exposed by shears and corresponds to a disarm action that is
	 * triggered by breaking a block that supports such behaviour. Example: Breaking
	 * a trip wire with shears to disarm it.
	 */
	public static final ToolAction SHEARS_DISARM = ToolAction.get("shears_disarm");

	/**
	 * Passed onto {@link BlockExtensions#getToolModifiedState} when a hoe wants to
	 * turn dirt into soil
	 */
