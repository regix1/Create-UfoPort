...
import io.github.fabricators_of_create.porting_lib_ufo.models.geometry.RegisterGeometryLoadersCallback;
import io.github.fabricators_of_create.porting_lib_ufo.models.util.TransformationHelper;
...
public class PortingLibModels implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		RegisterGeometryLoadersCallback.EVENT.register(loaders -> {
			...
			loaders.put(ResourceLocation.fromNamespaceAndPath("forge", "bucket"), DynamicFluidContainerModel.Loader.INSTANCE_DEPRECATED);
		});
