package io.github.fabricators_of_create.porting_lib_ufo.data;
...
public abstract class SpriteSourceProvider extends JsonCodecProvider<List<SpriteSource>> {
	protected static final ResourceLocation BLOCKS_ATLAS = ResourceLocation.parse("blocks");
	protected static final ResourceLocation BANNER_PATTERNS_ATLAS = ResourceLocation.parse("banner_patterns");
	protected static final ResourceLocation BEDS_ATLAS = ResourceLocation.parse("beds");
	protected static final ResourceLocation CHESTS_ATLAS = ResourceLocation.parse("chests");
	protected static final ResourceLocation SHIELD_PATTERNS_ATLAS = ResourceLocation.parse("shield_patterns");
	protected static final ResourceLocation SHULKER_BOXES_ATLAS = ResourceLocation.parse("shulker_boxes");
	protected static final ResourceLocation SIGNS_ATLAS = ResourceLocation.parse("signs");
	protected static final ResourceLocation MOB_EFFECTS_ATLAS = ResourceLocation.parse("mob_effects");
	protected static final ResourceLocation PAINTINGS_ATLAS = ResourceLocation.parse("paintings");
	protected static final ResourceLocation PARTICLES_ATLAS = ResourceLocation.parse("particles");
