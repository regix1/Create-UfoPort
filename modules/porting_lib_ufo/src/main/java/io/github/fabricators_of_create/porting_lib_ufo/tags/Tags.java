package io.github.fabricators_of_create.porting_lib_ufo.tags;
...
public class Tags implements ModInitializer {
	...
	public static class Items {
		...
		public static final TagKey<Item> DYES_BLACK = DyeColor.BLACK.getDyesTag();
		public static final TagKey<Item> DYES_RED = DyeColor.RED.getDyesTag();
		public static final TagKey<Item> DYES_GREEN = DyeColor.GREEN.getDyesTag();
		public static final TagKey<Item> DYES_BROWN = DyeColor.BROWN.getDyesTag();
		public static final TagKey<Item> DYES_BLUE = DyeColor.BLUE.getDyesTag();
		public static final TagKey<Item> DYES_PURPLE = DyeColor.PURPLE.getDyesTag();
		public static final TagKey<Item> DYES_CYAN = DyeColor.CYAN.getDyesTag();
		public static final TagKey<Item> DYES_LIGHT_GRAY = DyeColor.LIGHT_GRAY.getDyesTag();
		public static final TagKey<Item> DYES_GRAY = DyeColor.GRAY.getDyesTag();
		public static final TagKey<Item> DYES_PINK = DyeColor.PINK.getDyesTag();
		public static final TagKey<Item> DYES_LIME = DyeColor.LIME.getDyesTag();
		public static final TagKey<Item> DYES_YELLOW = DyeColor.YELLOW.getDyesTag();
		public static final TagKey<Item> DYES_LIGHT_BLUE = DyeColor.LIGHT_BLUE.getDyesTag();
		public static final TagKey<Item> DYES_MAGENTA = DyeColor.MAGENTA.getDyesTag();
		public static final TagKey<Item> DYES_ORANGE = DyeColor.ORANGE.getDyesTag();
		public static final TagKey<Item> DYES_WHITE = DyeColor.WHITE.getDyesTag();
		 ...
		 * Please use {@link io.github.fabricators_of_create.porting_lib_ufo.tool.ToolActions} instead for what action a tool can do.
		 *
		 * @see ToolAction
		 * @see ToolActions
		 */
		 ...
		 * Please use {@link io.github.fabricators_of_create.porting_lib_ufo.tool.ToolActions} instead for what action a tool can do.
		 *
		 * @see io.github.fabricators_of_create.porting_lib_ufo.tool.ToolAction
		 * @see io.github.fabricators_of_create.porting_lib_ufo.tool.ToolActions
		 */
