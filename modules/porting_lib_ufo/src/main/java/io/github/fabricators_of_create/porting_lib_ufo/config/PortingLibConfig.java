package io.github.fabricators_of_create.porting_lib_ufo.config;
...
public class PortingLibConfig implements ModInitializer {
	...
	public static final ResourceLocation CONFIG_SYNC = ResourceLocation.fromNamespaceAndPath("porting_lib_config", "config_sync");
