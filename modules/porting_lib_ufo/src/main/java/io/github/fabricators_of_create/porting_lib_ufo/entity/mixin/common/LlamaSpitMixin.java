...
import io.github.fabricators_of_create.porting_lib_ufo.entity.events.ProjectileImpactEvent;
...
//			return true; // NeoForge prevents any misses here, however vanilla doesn't so we keep vanilla
//							// behavior
