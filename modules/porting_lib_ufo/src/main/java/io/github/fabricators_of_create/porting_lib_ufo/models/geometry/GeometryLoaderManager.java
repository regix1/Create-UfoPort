package io.github.fabricators_of_create.porting_lib_ufo.models.geometry;
...
public final class GeometryLoaderManager {
	...
	public static String getModelLoader(JsonObject json) {
		if (json.has("porting_lib_ufo:loader")) {
			return GsonHelper.getAsString(json, "porting_lib_ufo:loader");
	 ...
	 *     "custom": {
	 *         "porting_lib_ufo:provided_loaders": [
	 *             "my_mod:my_loader",
	...
	private static void getProvidedLoaders(Map<ResourceLocation, IGeometryLoader<?>> loaders) {
		...
		for (ModContainer mod : FabricLoader.getInstance().getAllMods()) {
			CustomValue provided = mod.getMetadata().getCustomValue("porting_lib_ufo:provided_loaders");
			if (provided == null) {
				continue;
			}
