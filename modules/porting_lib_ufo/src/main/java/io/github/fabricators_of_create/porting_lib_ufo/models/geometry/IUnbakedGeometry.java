...
public interface IUnbakedGeometry<T extends IUnbakedGeometry<T>> {
	BakedModel bake(BlockModel context, ModelBaker baker, Function<Material, TextureAtlasSprite> spriteGetter,
	...
	/**
	 * {@return a set of all the components whose visibility may be configured via
	 * {@link BlockModel}}
	 */
