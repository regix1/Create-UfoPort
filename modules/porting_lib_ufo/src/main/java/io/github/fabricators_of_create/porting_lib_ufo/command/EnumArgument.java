package io.github.fabricators_of_create.porting_lib_ufo.command;
...
public class EnumArgument<T extends Enum<T>> implements ArgumentType<T> {
	private static final Dynamic2CommandExceptionType INVALID_ENUM = new Dynamic2CommandExceptionType(
			(found, constants) -> Component.translatable("commands.porting_lib_ufo.arguments.enum.invalid", constants, found));
