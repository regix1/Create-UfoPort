package io.github.fabricators_of_create.porting_lib_ufo.tags.data;
...
public final class BiomeTagsProvider extends FabricTagProvider<Biome> {
	...
	protected void addTags(HolderLookup.Provider lookupProvider) {
		...
		tag(Tags.Biomes.IS_END).addOptionalTag(BiomeTags.IS_END.location());
		tag(Tags.Biomes.IS_NETHER).addOptionalTag(BiomeTags.IS_NETHER.location());
		tag(Tags.Biomes.IS_OVERWORLD).addOptionalTag(BiomeTags.IS_OVERWORLD.location());
		...
		tag(Tags.Biomes.IS_MOUNTAIN).addOptionalTag(BiomeTags.IS_MOUNTAIN.location()).addTag(Tags.Biomes.IS_MOUNTAIN_PEAK).addTag(Tags.Biomes.IS_MOUNTAIN_SLOPE);

		tag(Tags.Biomes.IS_FOREST).addOptionalTag(BiomeTags.IS_FOREST.location());
		...
		tag(Tags.Biomes.IS_BEACH).addOptionalTag(BiomeTags.IS_BEACH.location());
		tag(Tags.Biomes.IS_STONY_SHORES).add(Biomes.STONY_SHORE);
		tag(Tags.Biomes.IS_DESERT).add(Biomes.DESERT);
		tag(Tags.Biomes.IS_BADLANDS).addOptionalTag(BiomeTags.IS_BADLANDS.location());
		...
		tag(Tags.Biomes.IS_TAIGA).addOptionalTag(BiomeTags.IS_TAIGA.location());
		tag(Tags.Biomes.IS_HILL).addOptionalTag(BiomeTags.IS_HILL.location());
		...
		tag(Tags.Biomes.IS_SAVANNA).addOptionalTag(BiomeTags.IS_SAVANNA.location());
		tag(Tags.Biomes.IS_JUNGLE).addOptionalTag(BiomeTags.IS_JUNGLE.location());
		...
		tag(Tags.Biomes.IS_RIVER).addOptionalTag(BiomeTags.IS_RIVER.location());
		...
		tag(Tags.Biomes.IS_DEEP_OCEAN).addOptionalTag(BiomeTags.IS_DEEP_OCEAN.location());
		tag(Tags.Biomes.IS_OCEAN).addOptionalTag(BiomeTags.IS_OCEAN.location()).addTag(Tags.Biomes.IS_SHALLOW_OCEAN).addTag(Tags.Biomes.IS_DEEP_OCEAN);
